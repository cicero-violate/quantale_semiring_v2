...
_BUILTIN_TEMPLATES = {
    "plan": (
        ...
        '\n'
        'DEVELOPMENT CYCLE — always include exactly one of these edges in every plan:\n'
        '  State::Learn -> State::Introspect  (confidence 0.4-0.6) — trigger topology self-development\n'
        '  State::Learn -> State::PatternPlan (confidence 0.3-0.5) — evolve CKA execution patterns\n'
        'Alternate between them across plans. Do not propose both in the same plan.\n'
        '\n'
